...
from student_management_app.StudentViews import save_subjects
...
from student_management_app.StudentViews import apply_exam
...
urlpatterns = [
    ...
    path('admission/', HodViews.admission_view, name='admission_view'),
    ...
    path('apply_exam.html', StudentViews.apply_exam,name='student_apply_exam'),
    path('firebase-messaging-sw.js',views.showFirebaseJS,name="show_firebase_js"),
    path('save_subjects/', save_subjects, name='save_subjects'),
